...
<table width="97%" border="0" cellspacing="0" cellpadding="0">
	<tr height="40"> 
		<td width="46%" style="text-align: left"> 
			&nbsp;&nbsp;&nbsp; <img src="<%=contextPath%>/EventBoard/images/board02.gif" width="150" height="30">
		</td>
	</tr>
	<tr> 
		<td colspan="3">
			<div align="center">
				<img src="<%=contextPath%>/EventBoard/images/line_870.gif" width="870" height="4">
			</div>
		</td>
	</tr>
	<tr> 
	    	...
	    	<table width="95%" border="0" cellspacing="0" cellpadding="0">
	        	...
	        	<tr>
	        		<td colspan="4" style="height: 19px">
	        			<img src="<%=contextPath%>/EventBoard/images/ink.gif" width="875" height="100">
	        		</td>
	        	</tr>
	        	<tr> 
	        		<td colspan="4">
...
<%-- 										<%}%> --%>
				...
				<tr>
					<form action="<%=contextPath%>/EventBoard/searchlist.bo" 
							method="post" 
		            ...
		            %>
		             	<input type="image" 
		             			id="newContent" 
				             	src="<%=contextPath%>/EventBoard/images/write.gif" 
				             	onclick="location.href='<%=contextPath%>/EventBoard/write.bo?nowPage=<%=nowPage%>&nowBlock=<%=nowBlock%>'"
	...
	<tr align="center"> 
		...
		<%
			if(totalRecord != 0){ //DB에 글이 있다면?
				...
				if(nowBlock > 0){
		%>			
					<a href="<%=contextPath%>/EventBoard/list.bo?nowBlock=<%=nowBlock-1%>&nowPage=<%=((nowBlock-1)*pagePerBlock)%>">
					◀ 이전 <%=pagePerBlock%>개
					</a>
				<%}%>
		...
		%>
					&nbsp;&nbsp;
					<a href="<%=contextPath%>/EventBoard/list.bo?nowBlock=<%=nowBlock%>&nowPage=<%=(nowBlock * pagePerBlock)+i%>">
