...
public class EventBoardController extends HttpServlet{
	...
	//부장
	EventBoardService boardservice;
//	 
...
//	MemberDAO memberdao;
	...
	public void init() throws ServletException {
		...
		boardservice = new EventBoardService();
	}
	...
	private void doHandle(HttpServletRequest request, 
		...
		//-----	
			...
			request.setAttribute("center", "board/EventWrite.jsp");
		...
		case "/read.bo":
			...
			request.setAttribute("center", "board/EventRead.jsp");
		...
		case "/reply.do":
			...
			request.setAttribute("center", "board/EventReply.jsp");
